    ...
    <div class="zmz-cron-datetime">
        <div class="zmz-cron-datetime__item">
            <div class="zmz-cron-datetime__item__radio" :class="{ 'zmz-cron-datetime__item__radio--active': currentType == '1' }"
                ...
                <span class="zmz-cron-datetime__item__radio__text">每周</span>
            </div>
        </div>
        <div class="zmz-cron-datetime__item">
        ...
        <div class="zmz-cron-datetime__item">
            <div class="zmz-cron-datetime__item__radio" :class="{ 'zmz-cron-datetime__item__radio--active': currentType == '2' }"
                ...
                <span class="zmz-cron-datetime__item__radio__dot"></span>
                <span class="zmz-cron-datetime__item__radio__text">从星期</span>
            </div>
            <div class="zmz-cron-datetime__item__text">从星期</div>
            <div class="zmz-cron-datetime__item__input">
                <input class="zmz-cron-datetime__item__input__inner" type="number" v-model="cycle.start"
                    @input="handleCycleStart('2')" :min="1" :max="7">
            </div>
            <div class="zmz-cron-datetime__item__text">至星期</div>
            <div class="zmz-cron-datetime__item__input">
                <input class="zmz-cron-datetime__item__input__inner" type="number" v-model="cycle.end"
                    @input="handleCycleEnd('2')" :min="1" :max="7">
            </div>
        </div>
        <div class="zmz-cron-datetime__item">
            ...
            <div class="zmz-cron-datetime__item__input">
                <input class="zmz-cron-datetime__item__input__inner" type="number" v-model="loop.start"
                    @input="handleLoopStart('3')" :min="1" :max="7">
            </div>
            <div class="zmz-cron-datetime__item__text">开始，每</div>
            <div class="zmz-cron-datetime__item__input">
                <input class="zmz-cron-datetime__item__input__inner" type="number" v-model="loop.end"
                    @input="handleLoopEnd('3')" :min="1" :max="7">
            </div>
            <div class="zmz-cron-datetime__item__text">天执行一次</div>
        </div>
        <div class="zmz-cron-datetime__item">
            <div class="zmz-cron-datetime__item__radio" :class="{ 'zmz-cron-datetime__item__radio--active': currentType == '7' }"
                @click="handleTypeClick('7')">
                <span class="zmz-cron-datetime__item__radio__dot"></span>
                <span class="zmz-cron-datetime__item__radio__text">指定周</span>
            </div>
            <div class="zmz-cron-datetime__item__text">本月第</div>
            <div class="zmz-cron-datetime__item__input">
                <input class="zmz-cron-datetime__item__input__inner" type="number" v-model="week.start"
                    @input="handleWeekStart('7')" :min="1" :max="4">
            </div>
            <div class="zmz-cron-datetime__item__text">周，星期</div>
            <div class="zmz-cron-datetime__item__input">
                <input class="zmz-cron-datetime__item__input__inner" type="number" v-model="week.end"
                    @input="handleWeekEnd('7')" :min="1" :max="7">
            </div>
        </div>
        <div class="zmz-cron-datetime__item">
            <div class="zmz-cron-datetime__item__radio" :class="{ 'zmz-cron-datetime__item__radio--active': currentType == '6' }"
                @click="handleTypeClick('6')">
                <span class="zmz-cron-datetime__item__radio__dot"></span>
                <span class="zmz-cron-datetime__item__radio__text">本月最后一个</span>
            </div>
            <div class="zmz-cron-datetime__item__text">星期</div>
            <div class="zmz-cron-datetime__item__input">
                <input class="zmz-cron-datetime__item__input__inner" type="number" v-model="last" @input="handleLast('6')"
                    :min="1" :max="7">
            </div>
        </div>
        <div class="zmz-cron-datetime__item zmz-cron-datetime__item__column">
            ...
            <div class="zmz-cron-datetime__item__checkbox__group">
                <div class="zmz-cron-datetime__item__checkbox__group__item">
                    <div class="zmz-cron-datetime__item__checkbox"
                        :class="{ 'zmz-cron-datetime__item__checkbox--active': appoint.includes(i) }" v-for="i in 7" :key="i"
                        @click="handleMonth('4', i)">
                        <span class="zmz-cron-datetime__item__checkbox__dot"></span>
                        <span class="zmz-cron-datetime__item__checkbox__text">{{ i }}</span>
                    </div>
                </div>
            </div>
        </div>
