  ...
  <div class="zmz-cron-datetime">
    <div class="zmz-cron-datetime__item">
      <div class="zmz-cron-datetime__item__radio" :class="{ 'zmz-cron-datetime__item__radio--active': currentType == '1' }"
        ...
        <span class="zmz-cron-datetime__item__radio__text">每月</span>
      </div>
    </div>
    <div class="zmz-cron-datetime__item">
    ...
    <div class="zmz-cron-datetime__item">
      ...
      <div class="zmz-cron-datetime__item__input">
        <input class="zmz-cron-datetime__item__input__inner" type="number" v-model="cycle.start"
          @input="handleCycleStart('2')" :min="1" :max="12" />
      </div>
      <div class="zmz-cron-datetime__item__text">至</div>
      <div class="zmz-cron-datetime__item__input">
        <input class="zmz-cron-datetime__item__input__inner" type="number" v-model="cycle.end" @input="handleCycleEnd('2')"
          :min="1" :max="12" />
      </div>
      <div class="zmz-cron-datetime__item__text">月</div>
    </div>
    <div class="zmz-cron-datetime__item">
      ...
      <div class="zmz-cron-datetime__item__text">从</div>
      <div class="zmz-cron-datetime__item__input">
        <input class="zmz-cron-datetime__item__input__inner" type="number" v-model="loop.start" @input="handleLoopStart('3')"
          :min="1" :max="12" />
      </div>
      <div class="zmz-cron-datetime__item__text">月开始，每</div>
      <div class="zmz-cron-datetime__item__input">
        <input class="zmz-cron-datetime__item__input__inner" type="number" v-model="loop.end" @input="handleLoopEnd('3')"
          :min="1" :max="12" />
      </div>
      <div class="zmz-cron-datetime__item__text">月执行一次</div>
    </div>
      ...
      <div class="zmz-cron-datetime__item__checkbox__group">
        <div class="zmz-cron-datetime__item__checkbox__group__item">
          <div class="zmz-cron-datetime__item__checkbox"
            :class="{ 'zmz-cron-datetime__item__checkbox--active': appoint.includes(i) }" v-for="i in 12" :key="i"
