    ...
    <div class="zmz-cron-datetime">
        <div class="zmz-cron-datetime__item">
            <div class="zmz-cron-datetime__item__radio" :class="{ 'zmz-cron-datetime__item__radio--active': currentType == '1' }"
                ...
                <span class="zmz-cron-datetime__item__radio__text">每日</span>
            </div>
        </div>
        <div class="zmz-cron-datetime__item">
        ...
        <div class="zmz-cron-datetime__item">
            ...
            <div class="zmz-cron-datetime__item__input">
                <input class="zmz-cron-datetime__item__input__inner" type="number" v-model="cycle.start"
                    @input="handleCycleStart('2')" :min="1" :max="31">
            </div>
            ...
            <div class="zmz-cron-datetime__item__input">
                <input class="zmz-cron-datetime__item__input__inner" type="number" v-model="cycle.end"
                    @input="handleCycleEnd('2')" :min="2" :max="31">
            </div>
            <div class="zmz-cron-datetime__item__text">日</div>
        </div>
        <div class="zmz-cron-datetime__item">
            ...
            <div class="zmz-cron-datetime__item__input">
                <input class="zmz-cron-datetime__item__input__inner" type="number" v-model="loop.start"
                    @input="handleLoopStart('3')" :min="1" :max="31">
            </div>
            <div class="zmz-cron-datetime__item__text">日开始，每</div>
            <div class="zmz-cron-datetime__item__input">
                <input class="zmz-cron-datetime__item__input__inner" type="number" v-model="loop.end" @input="handleLoopEnd('3')"
                    :min="1" :max="31">
            </div>
            <div class="zmz-cron-datetime__item__text">日执行一次</div>
        </div>
        <div class="zmz-cron-datetime__item">
            <div class="zmz-cron-datetime__item__radio" :class="{ 'zmz-cron-datetime__item__radio--active': currentType == '8' }"
                @click="handleTypeClick('8')">
                <span class="zmz-cron-datetime__item__radio__dot"></span>
                <span class="zmz-cron-datetime__item__radio__text">工作日</span>
            </div>
            <div class="zmz-cron-datetime__item__text">本月</div>
            <div class="zmz-cron-datetime__item__input">
                <input class="zmz-cron-datetime__item__input__inner" type="number" v-model="work" @change="handleWork('8')"
                    :min="1" :max="31">
            </div>
            <div class="zmz-cron-datetime__item__text">号，最近的工作日</div>
        </div>
        <div class="zmz-cron-datetime__item">
            <div class="zmz-cron-datetime__item__radio" :class="{ 'zmz-cron-datetime__item__radio--active': currentType == '6' }"
                ...
                <span class="zmz-cron-datetime__item__radio__dot"></span>
                <span class="zmz-cron-datetime__item__radio__text">本月最后一天</span>
            </div>
        </div>
        <div class="zmz-cron-datetime__item zmz-cron-datetime__item__column">
            ...
            <div class="zmz-cron-datetime__item__checkbox__group">
                <div class="zmz-cron-datetime__item__checkbox__group__item" v-for="i in 4" :key="i">
                    <template v-for="j in 10">
                        <div @change="type = '4'" v-if="parseInt((i - 1) + '' + (j - 1)) < 32 && !(i === 1 && j === 1)"
                            :class="{ 'zmz-cron-datetime__item__checkbox--active': appoint.includes((i - 1) + '' + (j - 1)) }" :key="j"
                            class="zmz-cron-datetime__item__checkbox"  @click="handleMonth('4', (i - 1) + '' + (j - 1))">
